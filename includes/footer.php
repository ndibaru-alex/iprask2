                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-4 wow fadeInUp" data-wow-delay="300ms">
                                            <div class="footer-widget__column footer-widget__contact clearfix">
                                                <h3 class="footer-widget__title">Quick Contact</h3>
                                                <a href="mailto:info@iprask.org">info@iprask.org</a>
                                                <p class="footer-widget__contact-text"> 07 23 656 789 </p>
                                                <p class="footer-widget__contact-text"> Jkuat Towers 17th Floor </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-4 wow fadeInUp" data-wow-delay="200ms">
                                            <div class="footer-widget__column footer-widget__links clearfix">
                                                ...
                                                <iframe width="100%" height="100%" id="gmap_canvas"
                                                            src="https://maps.google.com/maps?q=jkuat%20towers&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0"
