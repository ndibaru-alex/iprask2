...
<body>
    <div class="preloader">
        <img class="preloader__image" width="60" src="assets/img-v1/favicon/android-chrome-192x192.png" alt="" />
    </div>
    <!-- /.preloader -->
    ...
    "autoplay": {
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title">Consulting Market Leader Expert</h2>
                            </div>
                            <div class="about-one__business-start">
                                <div class="about-one__business-start-icon">
                                    <span class="icon-verification"></span>
                                </div>
                                <p class="about-one__business-start-text">We’re in this business since 1988 and provide
                                    the best services</p>
                            </div>
                            ...
                            <p class="about-one__right-text">The majority have suffered alteration in some form, by
                            ...
                            <div class="about-one__bottom">
                                ...
                                <div class="about-one__contact">
                                    ...
                                    <div class="about-one__contact-phone">
                                        <p class="about-one__contact-text">Call Anytime</p>
                                        <a href="tel:13077760608">+254 722 327594</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12">
                        <div class="our-mission__inner">
                            <h2 class="our-mission__title">Our Mission is to Protect your <br> <span>Business</span> &
                                Much More</h2>
                            <a href="about.php" class="thm-btn our-mission__btn">free consultation</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="building-experience">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xl-7">
                            <div class="building-experience__top-left">
                                <div class="section-title text-left">
                                    <span class="section-title__tagline">company benefits & soltutions</span>
                                    <h2 class="section-title__title">Building Experience & <br> Give High Success Rates
                                    </h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5">
                            <div class="building-experience__top-right">
                                <p class="building-experience__top-right-text">There are many variations of passages of
                        ...
                        <div class="col-xl-6">
                            <div class="building-experience__bottom-content">
                                <div class="building-experience__bottom-img">
                                    <img src="assets/images/resources/building-experience-bottom-img.jpg" alt="">
                                </div>
                                        ...
                                        <div class="building-experience__progress-single">
                                            <div class="building-experience__progress-box">
                                                <div class="circle-progress"
                                                    data-options='{ "value": 0.9,"thickness": 4,"emptyFill": "#edf3f6","lineCap": "square", "size": 122, "fill": { "color": "#102447" } }'>
                                                </div><!-- /.circle-progress -->
                                                <span>90%</span>
                                            </div>
                                            <div class="building-experience__progress-content">
                                                <h3>Affordable <br> Cost</h3>
                                            </div>
                                        </div>
                                        <div
                                            class="building-experience__progress-single building-experience__progress-single-last">
                                            <div class="building-experience__progress-box">
                                                <div class="circle-progress"
                                                    data-options='{ "value": 0.5,"thickness": 4,"emptyFill": "#edf3f6","lineCap": "square", "size": 122, "fill": { "color": "#102447" } }'>
                                                </div><!-- /.circle-progress -->
                                                <span>50%</span>
                                            </div><!-- /.about-five__progress-box -->
                                            <div class="building-experience__progress-content">
                                                <h3>Quality <br> of Work</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="accrodion-content">
                                            <div class="inner">
                                                <p>Suspendisse finibus urna mauris, vitae consequat quam vel. Vestibulum
                                                    leo ligula, vit commodo nisl Sed luctus venenatis pellentesque.</p>
                                            </div><!-- /.inner -->
                                        </div>
                                    </div>
                                    <div class="accrodion">
        ...
        <section class="case-one">
            <div class="case-one__container">
                <div class="section-title text-center">
                    <span class="section-title__tagline">recently completed</span>
                                ...
                                <div class="case-one__img-box">
                                    <div class="case-one__img">
                                        ...
                                        <div class="case-one__content">
                                            <p class="case-one__tagline-line">Business, Finance</p>
                                            <h3 class="case-one__title"><a href="case-single.html">Business Growth</a>
                                            </h3>
                                            <div class="case-one__icon">
                                                <a href="case-single.html"><span class="icon-right-arrow"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="case-one__hover">
                                        <p class="case-one__hover-tagline-line">Business, Finance</p>
                                        <h3 class="case-one__hover-title"><a href="case-single.html">Business Growth</a>
                                        </h3>
                                        <p class="case-one__hover-text">Suspendisse finibus urna mauris, <br> vitae quam
                                            vel. Vestibulum leo <br> ligula, ed luctus.</p>
                            ...
                            <div class="case-one__single">
                                <div class="case-one__img-box">
                                    <div class="case-one__img">
                                        ...
                                        <div class="case-one__content">
                                            <p class="case-one__tagline-line">Business, Finance</p>
                                            <h3 class="case-one__title"><a href="case-single.html">Marketing Advice</a>
                                            </h3>
                                            <div class="case-one__icon">
                                                <a href="case-single.html"><span class="icon-right-arrow"></span></a>
                                            </div>
                                    ...
                                    <div class="case-one__hover">
                                        <p class="case-one__hover-tagline-line">Business, Finance</p>
                                        <h3 class="case-one__hover-title"><a href="case-single.html">Marketing
                                                Advice</a></h3>
                                        <p class="case-one__hover-text">Suspendisse finibus urna mauris, <br> vitae quam
                                            vel. Vestibulum leo <br> ligula, ed luctus.</p>
                                        <div class="case-one__hover-icon">
                            ...
                            <div class="case-one__single">
                                <div class="case-one__img-box">
                                    <div class="case-one__img">
                                        ...
                                        <div class="case-one__content">
                                            <p class="case-one__tagline-line">Business, Finance</p>
                                            <h3 class="case-one__title"><a href="case-single.html">Finance
                                                    Consulting</a></h3>
                                            <div class="case-one__icon">
                                                <a href="case-single.html"><span class="icon-right-arrow"></span></a>
                                            </div>
                                    ...
                                    <div class="case-one__hover">
                                        <p class="case-one__hover-tagline-line">Business, Finance</p>
                                        <h3 class="case-one__hover-title"><a href="case-single.html">Finance
                                                Consulting</a></h3>
                                        <p class="case-one__hover-text">Suspendisse finibus urna mauris, <br> vitae quam
                                            vel. Vestibulum leo <br> ligula, ed luctus.</p>
                                        <div class="case-one__hover-icon">
                            ...
                            <div class="case-one__single">
                                <div class="case-one__img-box">
                                    <div class="case-one__img">
                                        ...
                                        <div class="case-one__content">
                                            <p class="case-one__tagline-line">Business, Finance</p>
                                            <h3 class="case-one__title"><a href="case-single.html">Digital Campaigns</a>
                                            </h3>
                                            <div class="case-one__icon">
                                                <a href="case-single.html"><span class="icon-right-arrow"></span></a>
                                            </div>
                                    ...
                                    <div class="case-one__hover">
                                        <p class="case-one__hover-tagline-line">Business, Finance</p>
                                        <h3 class="case-one__hover-title"><a href="case-single.html">Digital
                                                Campaigns</a></h3>
                                        <p class="case-one__hover-text">Suspendisse finibus urna mauris, <br> vitae quam
                                            vel. Vestibulum leo <br> ligula, ed luctus.</p>
                                        <div class="case-one__hover-icon">
                    ...
                    <div class="col-xl-12">
                        <div class="testimonial-one__carousel owl-theme owl-carousel">
                            ...
                            <div class="testimonial-one__single">
                                ...
                                <div class="testimonial-one__author">
                                    <div class="testimonial-one__author-img">
                                        <img src="assets/images/testimonial/testi-author-1.jpg" alt="">
                                    </div>
                            ...
                            <div class="testimonial-one__single">
                                ...
                                <div class="testimonial-one__author">
                                    <div class="testimonial-one__author-img">
                                        <img src="assets/images/testimonial/testi-author-2.jpg" alt="">
                                    </div>
                                    <div class="testimonial-one__author-details">
                            ...
                            <div class="testimonial-one__single">
                                ...
                                <div class="testimonial-one__author">
                                    <div class="testimonial-one__author-img">
                                        <img src="assets/images/testimonial/testi-author-3.jpg" alt="">
                                    </div>
                                    <div class="testimonial-one__author-details">
                        ...
                        <div class="news-one__carousel owl-theme owl-carousel">
                            ...
                            <div class="news-one__single">
                                ...
                                <div class="news-one__content">
                                    ...
                                    <h3 class="news-one__title">
                                        <a href="news-details.php">Long Term Advice to Grow Businesses</a>
                                    </h3>
                                    <p class="news-one__text">Aellentesque porttitor lacus quis enim varius sed
                                        efficitur turpis gilla sed sit amet.</p>
                                    <div class="news-one__bottom">
                                        <a href="news-details.php" class="news-one__btn">Read More</a>
                                        <a href="news-details.php" class="news-one__arrow"><span
                            ...
                            <div class="news-one__single">
                                ...
                                <div class="news-one__content">
                                    ...
                                    <h3 class="news-one__title">
                                        <a href="news-details.php">Capitalize on low hanging fruit to</a>
                                    </h3>
                                    <p class="news-one__text">Aellentesque porttitor lacus quis enim varius sed
                                        efficitur turpis gilla sed sit amet.</p>
                                    <div class="news-one__bottom">
                            ...
                            <div class="news-one__single">
                                <div class="news-one__img">
                                    <img src="assets/images/blog/news-one-img-4.jpg" alt="">
                                    <a href="news-details.php">
                                        <span class="news-one__plus"></span>
                                    </a>
                                    <div class="news-one__date">
                                ...
                                <div class="news-one__content">
                                    ...
                                    <h3 class="news-one__title">
                                        <a href="news-details.php">DevOps. Nano technology along the</a>
                                    </h3>
                                    <p class="news-one__text">Aellentesque porttitor lacus quis enim varius sed
                                        efficitur turpis gilla sed sit amet.</p>
                                    <div class="news-one__bottom">
...
<!-- Mirrored from layerdrops.com/conult/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Apr 2023 14:59:54 GMT -->
</html>