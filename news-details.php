...
<head>
    ...
    <title>News Details || Conult || The society seeks to protect, advance and safeguard the rights and interests of its members by enhancing their capacity to detect infringements, file complaints, create awareness and generally fight counterfeiting on behalf of their appointing authorities</title>
    <!-- favicons Icons -->
                        ...
                        <div class="news-details__left">
                            ...
                            <div class="news-details__content">
                                <ul class="list-unstyled news-details__meta">
                                    <li><a href="news-details.php"><i class="far fa-user-circle"></i> Admin</a></li>
                            ...
                            <div class="comment-form">
                                ...
                                <form action="https://layerdrops.com/conult/assets/inc/sendemail.php" class="comment-one__form contact-form-validated" novalidate="novalidate">
                                    <div class="row">
                                        <div class="col-xl-6">
                        ...
                        <div class="sidebar">
                                    ...
                                    <li>
                                        ...
                                        <div class="sidebar__post-content">
                                            <h3>
                                                ...
                                                <a href="news-details.php">A Quick Solutions for Daily Banking</a>
                                            </h3>
                                        </div>
                                    </li>
                                    <li>
                            ...
                            <div class="sidebar__single sidebar__category">
                                ...
                                <ul class="sidebar__category-list list-unstyled">
                                    <li><a href="news-details.php">Consulting <span class="icon-right-arrow"></span></a></li>
                                    <li class="active"><a href="news-details.php">Marketing <span class="icon-right-arrow"></span></a></li>
                                    <li><a href="news-details.php">Technology <span class="icon-right-arrow"></span></a></li>
                                    <li><a href="news-details.php">Business & Finance<span class="icon-right-arrow"></span></a></li>
                                    <li><a href="news-details.php">Bank Cryptcy <span class="icon-right-arrow"></span></a></li>
                                </ul>
                            </div>
